		...
		return (
			<div className="bg-white dark:bg-slate-800 shadow-md rounded-lg p-6 border border-slate-200 dark:border-slate-700">
				...
				<div className="text-center py-8">
					<svg className="w-12 h-12 mx-auto mb-3 text-slate-400 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					...
					<p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Create your first content to see activity here</p>
				</div>
			</div>
		);
	}
		...
		<div className="bg-white dark:bg-slate-800 shadow-md rounded-lg p-6 border border-slate-200 dark:border-slate-700">
			...
			<div className="space-y-3">
				{activities.map((activity) => {
					...
					return (
						<div key={activity._id} className="flex items-start gap-3 p-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
							{/* Action icon */}
							...
							<div className="flex-1 min-w-0">
								{isContentAction ? (
									<Link
										...
										className="group"
									>
										<p className="text-sm font-medium text-slate-900 dark:text-slate-100 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors line-clamp-1">
