...
export function PersonaSelectStep({
	...
	if (personas === undefined) {
		return (
			<div className="text-center py-8">
				...
				<p className="mt-2 text-slate-500">Loading personas...</p>
			</div>
		);
	}
	...
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-2xl font-bold text-slate-900">Select Persona (Optional)</h2>
			...
			{personas === null || personas.length === 0 ? (
				<div className="bg-slate-50 border border-slate-200 rounded-lg p-6 text-center">
					<p className="text-slate-600 mb-2">No personas available for this project.</p>
