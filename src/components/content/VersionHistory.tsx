/**
 * VersionHistory component displays a list of content versions with pagination.
 * Shows version number, timestamp, label, current version indicator, and finalized badge.
 * Provides restore functionality for each version.
 */
			...
			{restoreConfirmId && (
				<div className="border-t border-slate-200 dark:border-slate-700 bg-amber-50 dark:bg-amber-950/30 p-4">
					<p className="text-sm text-amber-800 dark:text-amber-200">
						...
						This action is non-destructive and preserves all history.
					</p>
				</div>
			)}
		</div>
