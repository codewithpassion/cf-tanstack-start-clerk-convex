...
export function ReviewStep({
	...
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-2xl font-bold text-gray-900">Review Your Selections</h2>
			...
			<div className="space-y-4">
				...
				<div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
					<div className="flex justify-between items-start">
						<div className="flex-1">
							...
							<p className="text-gray-900 font-medium">{category?.name || "Unknown"}</p>
					...
					<div className="flex justify-between items-start">
						<div className="flex-1">
							...
							{persona ? (
								...
								<p className="text-gray-500 italic">No persona selected</p>
							)}
						</div>
						<button
							type="button"
				...
				<div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
					<div className="flex justify-between items-start">
						<div className="flex-1">
							<h3 className="text-sm font-medium text-gray-500 mb-1">Brand Voice</h3>
							{brandVoice ? (
								<>
									<p className="text-gray-900 font-medium">{brandVoice.name}</p>
									{brandVoice.description && (
										<p className="text-sm text-gray-600 mt-1">{brandVoice.description}</p>
									)}
								</>
							) : (
								<p className="text-gray-500 italic">No brand voice selected</p>
							)}
						</div>
						<button
							type="button"
				...
				<div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
					...
					<div className="space-y-2">
						...
						{draftContent && (
							<div>
								<p className="text-xs text-gray-500">Draft Content</p>
								<p className="text-sm text-gray-700 line-clamp-3">{draftContent}</p>
							</div>
						)}
