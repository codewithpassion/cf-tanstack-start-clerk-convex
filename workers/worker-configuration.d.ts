/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/worker-configuration.d.ts` (hash: 8151476ccd2d74309cc7b89e7474be1e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ENVIRONMENT: string;
		VITE_CLERK_TEST_EMAIL: string;
		VITE_CLERK_TEST_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VARIABLE" | "VITE_API_KEY" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_API_URL" | "CLERK_JWT_ISSUER_DOMAIN" | "ENVIRONMENT" | "VITE_CLERK_TEST_EMAIL" | "VITE_CLERK_TEST_PASSWORD" | "CONVEX_DEPLOYMENT" | "VITE_CONVEX_URL">> {}
}
